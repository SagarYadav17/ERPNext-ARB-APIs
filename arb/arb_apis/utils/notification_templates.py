...
def send_welcome_notification(username, first_name, phone, email):
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9fafb; border-radius: 0 0 10px 10px;">
            ...
            <p style="font-size: 14px; color: #6b7280; line-height: 1.6;">
                Get ready to explore thousands of electronic products at wholesale prices, 
                connect with verified suppliers, and grow your business with ARB.
            </p>
    ...
    if email and email != f"{phone}@arb.local":
        frappe.sendmail(
            recipients=email, subject=subject, message=message, now=True, delayed=False
        )
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9fafb; border-radius: 0 0 10px 10px;">
            ...
            <p style="font-size: 14px; color: #6b7280; line-height: 1.6;">
                ...
                support team immediately at <a href="mailto:support@arb.com" style="color: #10b981; text-decoration: none;">support@arb.com</a>
            </p>
